import React, { useReducer, useState } from "react"; //P.K. warning: 'useReducer' is defined but never used  @typescript-eslint/no-unused-vars
import { Country, countries } from '../../data/countries' //"../data/countries";
import './serhat.css'; //P.K. aded locally
//P.K. Module '"../../data/countries"' has no exported member 'Country'
//P.K. required tailwind.config.js in project base dir
//P.K. required: npm install tailwindcss
//npm install -D tailwindcss postcss autoprefixer
//npx tailwindcss init -p
//P.K. required: update package.json as including: "devDependencies": {  "tailwindcss": "^3.4.1" }
const CountryPage = () => {
